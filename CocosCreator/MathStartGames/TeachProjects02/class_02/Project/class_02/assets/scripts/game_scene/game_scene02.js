...
cc.Class({
    ...
    onLoad() {
        ...
        this.text_content.string = "请点击对应位置，添加1根火柴棒，使下面的算式成立。";
        ...
        for (let i = 1; i <= 6; i++) {
            ...
            node.getComponent("common_num").opt_type = 2;
        }
    },

    // // 准备数据
    // prepare_game: function() {
    //     this.can_add_times = 1;

    //     // 可以移动的数组
    //     this.can_add_node_list = {
    //         node_1: { // 3
    //             node_4: { is_right: false }
    //         },
    //         node_2: {
    ...
    get_result: function() {
        ...
        let val1 = parseInt(node_1_common.get_num_value() + "" + node_2_common.get_num_value());
        ...
        let val2 = node_4_common.get_num_value();
        ...
        let var_res = parseInt(node_5_common.get_num_value() + "" + node_6_common.get_num_value());
