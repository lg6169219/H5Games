...
cc.Class({
    ...
    onLoad() {
        ...
        this.text_content.string = "下面的数字只移动一根小棍，不移动其他小棍的情况下会变成哪个新数字呢？";
    ...
    start() {
        ...
        this.mov_one_info = new_node.getComponent("common_num").get_mov_one_info();
        this.can_create_times = 0;
        if (this.mov_one_info && this.mov_one_info !== null) {
            var arr = Object.keys(this.mov_one_info);
    ...
    get_result: function() {
        ...
        var arr_pre = Object.keys(this.mov_one_info);
