...
cc.Class({
    ...
    onLoad() {
        ...
        this.build_arrow_icon.tower_type = Tower_Type.DRY;
        ...
        this.build_bing_icon.tower_type = Tower_Type.WET;
        ...
        this.build_fasi_icon.tower_type = Tower_Type.RECYCLE;
        ...
        this.build_zd_icon.tower_type = Tower_Type.DETRIMENTAL;
