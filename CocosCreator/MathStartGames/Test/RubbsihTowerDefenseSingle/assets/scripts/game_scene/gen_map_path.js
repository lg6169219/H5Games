...
cc.Class({
    ...
    onLoad: function() {
        ...
        var game_map_data = require("game_map_" + this.node.name);
        console.log(game_map_data.data);
        this.road_data_set = game_map_data.data;
        ugame.set_map_road_set(this.road_data_set);
    },

    start: function() {
        // test()
        // var actor = cc.find("UI_ROOT/map_root/enemy_bear").getComponent("actor");
        // actor.create_at_road(this.road_data_set[0]);

        // actor = cc.find("UI_ROOT/map_root/enemy_forkman").getComponent("actor");
        // actor.create_at_road(this.road_data_set[1]);

        // actor = cc.find("UI_ROOT/map_root/enemy_carry").getComponent("actor");
        // actor.create_at_road(this.road_data_set[2]);
    },
