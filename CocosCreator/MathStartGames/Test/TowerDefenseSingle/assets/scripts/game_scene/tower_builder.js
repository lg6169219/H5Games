...
cc.Class({
    ...
    onLoad() {
        ...
        this.tower_params[2] = require("pao_tower_params");
        this.tower_params[3] = require("bing_tower_params");
    },
    ...
    undo_tower: function() {
        ...
        var params = this.tower_params[this.tower_type];
    ...
    _get_curr_tower_com: function() {
        ...
        switch (this.tower_type) {
            case Tower_Type.ARROW:
                ...
                break;
            case Tower_Type.FASHI:
                tower_com = this.builded_tower.getComponent("fashi_tower");
                break;
            case Tower_Type.PAO:
                tower_com = this.builded_tower.getComponent("pao_tower");
                break;
            case Tower_Type.BING:
                tower_com = this.builded_tower.getComponent("bing_tower");
                break;
            default:
                console.log("=========err tower_type ", this.tower_type);
        }
        return tower_com;
    },
